...
const copy = {
  en: {
    ...
    eyebrow: 'Open source · v0.2.4 prerelease', heroTitle: 'DeepSeek Harness,<br>without the terminal.',
    ...
    downloadsEyebrow: 'Download v0.2.4', downloadsTitle: 'Pick your platform.', downloadsLede: 'Current installers are unsigned prerelease builds. Check the published SHA-256 file after downloading.',
  ...
  zh: {
    ...
    eyebrow: '开源 · v0.2.4 预发布版', heroTitle: '使用 DeepSeek Harness，<br>不再守着命令行。',
    ...
    downloadsEyebrow: '下载 v0.2.4', downloadsTitle: '选择你的平台。', downloadsLede: '当前安装包是尚未签名的预发布构建。下载后请核对发布页提供的 SHA-256。',
