...
const strings = zh ? {
  title: '桌面控制中心', subtitle: '运行时、更新与本地桌面偏好', desktop: '桌面外壳', checkDesktop: '检查桌面应用更新',
  ...
  title: 'Desktop Control Center', subtitle: 'Runtime, updates, and local desktop preferences', desktop: 'Desktop shell', checkDesktop: 'Check desktop update',
...
const phases = zh ? {
  starting: '启动中', running: '运行中', recovering: '正在恢复', error: '启动失败', idle: '等待检查', disabled: '未启用', checking: '正在检查', current: '已是最新', downloading: '正在下载', prepared: '等待重启', ready: '等待退出安装',
} : {
  starting: 'Starting', running: 'Running', recovering: 'Recovering', error: 'Failed', idle: 'Waiting', disabled: 'Disabled', checking: 'Checking', current: 'Up to date', downloading: 'Downloading', prepared: 'Restart pending', ready: 'Installs after quit',
}
